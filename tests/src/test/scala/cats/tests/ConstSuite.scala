...
class ConstSuite extends CatsSuite {
  ...
  checkAll("Const[String, Int", DecidableTests[Const[String, *]].decidable[Int, Int, Int])
  checkAll("Decidable[Const[String, ?]]", SerializableTests.serializable(Decidable[Const[String, *]]))
