          ...
          tv =>
            new TemplatedBlock(tv) {
              ...
              def content =
                ...
                |      def empty: ${`(A..N)`} = ${nullaryTuple("empty")}
                |    }
                |  implicit def catsKernelStdGroupForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Group"
                )}): Group[${`(A..N)`}] =
                |    new Group[${`(A..N)`}] {
                |      def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
                ...
                |      def inverse(x: ${`(A..N)`}): ${`(A..N)`} = ${unaryTuple("inverse")}
                |    }
                |  implicit def catsKernelStdHashForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Hash"
                )}): Hash[${`(A..N)`}] =
                |    new Hash[${`(A..N)`}] {
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              ...
              def content =
                block"""
                |  implicit def catsKernelStdBandForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Band"
                )}): Band[${`(A..N)`}] =
                |    new Band[${`(A..N)`}] {
                |      def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
                ...
                |      def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
                |    }
                |  implicit def catsKernelStdMonoidForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Monoid"
                )}): Monoid[${`(A..N)`}] =
                |    new Monoid[${`(A..N)`}] {
                |      def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              ...
              def content =
                block"""
                |  implicit def catsKernelStdSemigroupForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Semigroup"
                )}): Semigroup[${`(A..N)`}] =
                |    new Semigroup[${`(A..N)`}] {
                |      def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
                |    }
                |  implicit def catsKernelStdEqForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Eq"
                )}): Eq[${`(A..N)`}] =
                |    new Eq[${`(A..N)`}] {
                |      def eqv(x: ${`(A..N)`}, y: ${`(A..N)`}): Boolean = ${binMethod("eqv").mkString(" && ")}
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelBandForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Band"
                )}): Band[${`(A..N)`}] = new Band[${`(A..N)`}] {
                 |    def combine(x: ${`(A..N)`}, y: ${`(A..N)`}): ${`(A..N)`} = ${binTuple("combine")}
                 |  }"""
            }
        ),
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelEqForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Eq"
                )}): Eq[${`(A..N)`}] = new Eq[${`(A..N)`}] {
                 |    def eqv(x: ${`(A..N)`}, y: ${`(A..N)`}): Boolean = ${binMethod("eqv").mkString(" && ")}
                 |  }"""
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelGroupForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Group"
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelHashForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Hash"
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelMonoidForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Monoid"
        ...
        InstanceDef(
          ...
          tv =>
            new TemplatedBlock(tv) {
              import tv._
              def content =
                block"""|  implicit def catsKernelOrderForTuple${arity}[${`A..N`}](implicit ${constraints(
                  "Order"
