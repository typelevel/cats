...
class OptionTTests extends CatsSuite {
...

  {
    ...
    checkAll("OptionT[ListWrapper, Int]", EqTypeclassTests[OptionT[ListWrapper, Int]].eqv)
...

  {
    ...
    checkAll("OptionT[ListWrapper, Int]", PartialOrderTypeclassTests[OptionT[ListWrapper, Int]].partialOrder)
...

  {
    ...
    checkAll("OptionT[ListWrapper, Int]", OrderTypeclassTests[OptionT[ListWrapper, Int]].order)
...

  {
    ...
    checkAll("OptionT[ListWrapper, Int]", MonoidTypeclassTests[OptionT[ListWrapper, Int]].monoid)
...

  {
    ...
    checkAll("OptionT[ListWrapper, Int]", SemigroupTypeclassTests[OptionT[ListWrapper, Int]].semigroup)
