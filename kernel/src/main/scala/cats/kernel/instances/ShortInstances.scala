...
trait ShortInstances {
  ...
  implicit val catsKernelStdBoundedForShort: LowerBounded[Short] with UpperBounded[Short] =
    new ShortBounded {
      override val partialOrder: PartialOrder[Short] = catsKernelStdOrderForShort
    }
}
