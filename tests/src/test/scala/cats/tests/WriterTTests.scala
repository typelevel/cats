...
class WriterTTests extends CatsSuite {
  ...
  checkAll("WriterT[List, Int, Int]", EqTypeclassTests[WriterT[List, Int, Int]].eqv)
...

  {
    ...
    checkAll("WriterT[ListWrapper, Int, Int]", MonoidTypeclassTests[WriterT[ListWrapper, Int, Int]].monoid)
    ...
    checkAll("Writer[Int, Int]", MonoidTypeclassTests[Writer[Int, Int]].monoid)
  }

  {
    ...
    checkAll("WriterT[ListWrapper, Int, Int]", SemigroupTypeclassTests[WriterT[ListWrapper, Int, Int]].semigroup)
    ...
    checkAll("Writer[Int, Int]", SemigroupTypeclassTests[Writer[Int, Int]].semigroup)
  }
