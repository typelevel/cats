...
class IndexedStoreTSuite extends CatsSuite {
...

  {
    ...
    checkAll("Functor[IndexedStoreT[NonEmptyListWrapper, String, Int, ?]]",
...

  {
    ...
    checkAll("Contravariant[IndexedStoreT[NonEmptyListWrapper, Int, ?, Int]]",
  ...
  {
    implicit val F: Comonad[NonEmptyListWrapper] = NonEmptyListWrapper.comonad
    implicit val FS: Bifunctor[IndexedStoreT[NonEmptyListWrapper, ?, Int, ?]] = IndexedStoreT.catsDataBifunctorForIndexedStoreT

    checkAll("IndexedStoreT[NonEmptyListWrapper, ?, Int, ?]",
