...
import cats.laws.discipline.{TraverseTests, ApplicativeTests => ApplicativeLawTests, SerializableTests}
...
class ValidatedTests extends CatsSuite {
  checkAll("Validated[String, Int]", ApplicativeLawTests[Validated[String,?]].applicative[Int, Int, Int])
