...
def mimaSettings(moduleName: String) = Seq(
  ...
  mimaBinaryIssueFilters ++= {
    ...
    Seq(
      ...
      exclude[ReversedMissingMethodProblem]("cats.Apply#Ops.apR"),
      exclude[ReversedMissingMethodProblem]("cats.Apply#Ops.apL"),
      exclude[ReversedMissingMethodProblem]("cats.Apply.<*>"),
      exclude[ReversedMissingMethodProblem]("cats.Apply.apR"),
      exclude[ReversedMissingMethodProblem]("cats.Apply.apL"),
      exclude[ReversedMissingMethodProblem]("cats.FlatMap.apREval"),
      exclude[ReversedMissingMethodProblem]("cats.FlatMap.apLEval"),
      ...
      exclude[ReversedMissingMethodProblem]("cats.FlatMap#Ops.apREval"),
      exclude[ReversedMissingMethodProblem]("cats.FlatMap#Ops.apLEval"),
      exclude[ReversedMissingMethodProblem]("cats.NonEmptyParallel.parApR"),
      exclude[ReversedMissingMethodProblem]("cats.NonEmptyParallel.parApL"),
      ...
      exclude[UpdateForwarderBodyProblem]("cats.instances.Tuple2Instances2.catsStdFlatMapForTuple2"),
      exclude[ReversedMissingMethodProblem]("cats.instances.Tuple2Instances2.catsStdCommutativeFlatMapForTuple2"),
      exclude[InheritedNewAbstractMethodProblem]("cats.instances.Tuple2Instances3.catsStdMonadForTuple2"),
