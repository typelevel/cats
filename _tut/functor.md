...
scala> implicit val optionFunctor: Functor[Option] = new Functor[Option] {
     ...
     | }
optionFunctor: cats.Functor[Option] = $anon$1@300f19d2

scala> implicit val listFunctor: Functor[List] = new Functor[List] {
     |   def map[A,B](fa: List[A])(f: A => B) = fa map f
     | }
listFunctor: cats.Functor[List] = $anon$1@2b71dcb6
```
...
listOpt: cats.Functor[[X]List[Option[X]]] = cats.Functor$$anon$1@246490b7
